...
const cases = [
  { title: "Intelligent workforce operations, unified", sector: "Workforce technology", result: "One operating view", text: "A multi-platform workforce suite connecting time, attendance, leave and operational insight across distributed teams.", tone: "blue", image: "/landing page/workforce technology.png" },
  ...
  { title: "Recruitment rebuilt around real workflows", sector: "Talent technology", result: "Less hiring friction", text: "A role-aware recruitment platform connecting candidate pipelines, collaboration and operational control.", tone: "green", image: "/landing page/talent technology.png" },
];
